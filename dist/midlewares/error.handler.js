...
// implementando o error handler default do Objetction.js  https://vincit.github.io/objection.js/recipes/error-handling.html#examples
exports.errorHandler = (err, req, res, next) => {
    ...
    else if (err instanceof objection_1.ConstraintViolationError) {
        res.status(409).send({
            message: err.message,
            type: 'ConstraintViolationError',
            data: {
                description: err.nativeError
            }
        });
    }
